            ...
            <div style={{ animation: 'fadeIn 0.3s' }}>
              ...
              <div className="preview-grid">
                ...
                <div className="preview-card">
                  ...
                  <div className="p-row"><span className="p-key">Value Added:</span> <span style={{color: 'var(--dash-accent)', fontWeight: 600}}>${formData.targetValue.toLocaleString()}</span></div>
