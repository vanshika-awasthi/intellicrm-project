...
const boardStyles = `
  ...
  .deal-card:hover { border-color: var(--dash-accent); box-shadow: 0 4px 12px rgba(29,158,117,0.08); }
  ...
  /* Generic Modals */
  .primary-btn {
    background: var(--dash-accent); color: #fff; padding: 10px 16px; border-radius: 8px; font-size: 14px; font-weight: 500; cursor: pointer; border: none; transition: 0.2s; display:inline-flex; align-items:center; gap: 8px;
  }
  ...
  .modal-content {
    ...
    padding: 1.5rem; border: 1px solid var(--dash-border);
  }
